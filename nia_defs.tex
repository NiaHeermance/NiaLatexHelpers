...
% .:*~*:._.:*~*:._.:*~*:._.:*~*:._.:*~*:._.:*~*:._.:*~*:._.:*~*:. %
  ...
  % PROGRAMMING
    ...
    % Generic Code
      % In-Line
      \newcommand{\codel}[1]{\texttt{#1}\hspace{-0.1em}}
      % Code Block
      \newenvironment{code}{\VerbatimEnvironment\begin{minted}{text}} {\end{minted}}

    % Python
      % In-Line
      \newcommand{\pythonl}[2][]{\mintinline[#1]{python}{#2}}
      % Code Block
      \newenvironment{python}{\VerbatimEnvironment\begin{minted}{python}} {\end{minted}}
